  ...
  return (
    <section ref={sectionRef} className="pt-10 pb-28 bg-[#FDF8F5] relative overflow-hidden font-sans">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {exhibitions.map((event) => (
            ...
            >
              {/* Rising Wave Hover Background - Goes from bottom to top with wave curves */}
              <div className="absolute bottom-0 left-0 right-0 h-0 group-hover:h-full transition-all duration-800 ease-out z-0 pointer-events-none overflow-hidden rounded-[24px]">
                <div className="relative w-full h-full bg-gradient-to-t from-[#90D5FF]/45 via-[#90D5FF]/30 to-[#90D5FF]/15">
                  {/* Animated Wave Curves at the top edge of the rising fill */}
                  <div className="absolute top-0 left-0 right-0 -translate-y-[85%] pointer-events-none">
                    <svg
                      className="w-[200%] h-12 text-[#90D5FF]/70 animate-wave-slow block"
                      viewBox="0 0 1200 120"
                      preserveAspectRatio="none"
                    >
                      <path
                        d="M0,45 C150,95 350,-15 600,45 C850,95 1050,-15 1200,45 L1200,120 L0,120 Z"
                        fill="currentColor"
                      />
                    </svg>
                    <svg
                      className="absolute top-0 left-0 w-[200%] h-12 text-[#29B6F6]/40 animate-wave-fast block"
                      viewBox="0 0 1200 120"
                      preserveAspectRatio="none"
                    >
                      <path
                        d="M0,30 C200,-25 400,85 600,30 C800,-25 1000,85 1200,30 L1200,120 L0,120 Z"
                        fill="currentColor"
                      />
                    </svg>
                  </div>
              ...
              {/* Highlight All Borders on Hover */}
              <div className="absolute inset-0 rounded-[24px] border-2 border-transparent group-hover:border-[#29B6F6] transition-colors duration-500 pointer-events-none z-20 shadow-[0_0_20px_rgba(41,182,246,0.3)] opacity-0 group-hover:opacity-100"></div>
              ...
              <div className="space-y-6 relative z-10">
                ...
                {/* Event Name */}
                <h3 className="text-lg font-bold text-[#0D0D39] dark:text-white leading-tight">
                  {event.name}
                </h3>
                ...
                <div className="space-y-3.5 font-sans pt-1">
                  ...
                  <div className="flex items-center space-x-3 text-xs text-slate-700 dark:text-slate-300">
                    <svg className="h-4.5 w-4.5 text-[#0575D7] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Location Block */}
              <div className="pt-5 border-t border-slate-200/60 dark:border-white/5 flex items-start space-x-2.5 text-xs text-slate-700 dark:text-slate-400 font-light font-sans relative z-10 mt-6 shrink-0">
                <div className="h-7 w-7 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0 text-[#0575D7]">
